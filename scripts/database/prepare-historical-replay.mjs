...
const seedUsersPatched = `INSERT INTO users (id, email, name, phone, role, status, cpf, birth_date)\nVALUES\n  ('11111111-1111-1111-1111-111111111101', 'aluno.demo@mazzi.com.br', 'Ana Clara Silva (Demo)', '11988880001', 'STUDENT', 'ACTIVE', '52998224725', '2000-01-01'),\n  ('11111111-1111-1111-1111-111111111102', 'carlos.instrutor@mazzi.com.br', 'Carlos Alberto de Souza (Demo)', '11988880002', 'INSTRUCTOR', 'ACTIVE', '11111111111', '1985-01-01'),\n  ('11111111-1111-1111-1111-111111111103', 'admin.paulista@mazzi.com.br', 'Diretor Autoescola Paulista (Demo)', '11988880003', 'SCHOOL_ADMIN', 'ACTIVE', '22222222222', '1980-01-01'),\n  ('11111111-1111-1111-1111-111111111104', 'marcos.instrutor@mazzi.com.br', 'Marcos Vinícius (Demo)', '11988880004', 'INSTRUCTOR', 'ACTIVE', '33333333333', '1987-01-01'),\n  ('11111111-1111-1111-1111-111111111105', 'admin.master@mazzi.com.br', 'Administrador MAZZI (Demo)', '11988880099', 'PLATFORM_ADMIN', 'ACTIVE', '44444444444', '1975-01-01');`;
