...
export const SearchHeader: React.FC<SearchHeaderProps> = ({
  ...
  return (
    <section className="space-y-4" aria-label="Buscar aulas">
      {isInitialLoading ? (
        <div aria-busy="true" aria-label="Carregando localização" className="mazzi-card space-y-3 p-3 sm:p-4">
      ...
      <form
        ...
        className={`transition-all ${isKeyboardOpen ? 'fixed inset-x-3 top-3 z-[70] mx-auto max-w-lg shadow-[0_14px_32px_rgba(16,24,40,0.18)]' : ''}`}
      >
        <LocationAddressField
          onLocate={() => void handleUseMyLocation()}
