...
export const NOTIFICATION_PREFERENCE_DEFINITIONS: readonly NotificationPreferenceDefinition[] = [
  ...
  { type: 'LESSON_STARTED', label: 'Aulas iniciadas', description: 'Quando uma aula começar.', icon: Clock3, contexts: STUDENT_CONTEXTS },
  { type: 'LESSON_COMPLETED', label: 'Aulas concluídas', description: 'Quando uma aula for concluída.', icon: CheckCircle2, contexts: STUDENT_CONTEXTS },
  ...
  { type: 'PAYOUT_PAID', label: 'Recebimentos liberados ou pagos', description: 'Quando um recebimento for liberado ou pago.', icon: CircleDollarSign, contexts: PRO_CONTEXTS },
