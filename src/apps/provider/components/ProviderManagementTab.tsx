    ...
    <div className="space-y-6 text-left">
                ...
                >
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-600">
                      ...
                      <span>Transmissão: {v.transmission === 'MANUAL' ? 'Manual' : 'Automática'}</span>
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-slate-500">
                        Transmissão: {o.transmission === 'MANUAL' ? 'Manual' : 'Automática'}
                      </p>
                    </div>
      ...
      <Modal isOpen={isAddVehicleModalOpen} onClose={onCloseAddVehicleModal} title="Cadastrar Veículo">
        <div className="space-y-4 text-left">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => onVehicleFormChange({ ...vehicleForm, licensePlate: e.target.value })}
          ...
          <div className="pt-2 flex justify-end gap-2 border-t border-slate-200">
            <Button variant="secondary" size="sm" onClick={onCloseAddVehicleModal}>
              Cancelar
            </Button>
            <Button variant="primary" size="sm" onClick={onSaveVehicle}>
              Salvar Veículo
            </Button>
          </div>
        </div>
      ...
      <Modal isOpen={isAddOfferingModalOpen} onClose={onCloseAddOfferingModal} title="Cadastrar Oferta de Aula">
        <div className="space-y-4 text-left">
          ...
          <div>
            ...
            <Select
              ...
              options={[
                ...
                ...vehicles.map((v) => ({ value: v.id, label: `${v.brand} ${v.model} (${v.licensePlate || 'Sem placa'}) - Cat. ${v.category}` })),
              ]}
            />
          </div>
          ...
          <div className="pt-2 flex justify-end gap-2 border-t border-slate-200">
            <Button variant="secondary" size="sm" onClick={onCloseAddOfferingModal}>
              Cancelar
            </Button>
            <Button variant="primary" size="sm" onClick={onSaveOffering}>
              Salvar Oferta
            </Button>
          </div>
        </div>
