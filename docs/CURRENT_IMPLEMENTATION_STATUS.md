...
| Pagamentos | Mercado Pago | `HOMOLOGAÇÃO/DEV` | [`src/apps/student/components/MercadoPagoCardCheckout.tsx`](../src/apps/student/components/MercadoPagoCardCheckout.tsx), [`src/apps/student/components/MercadoPagoPixCheckout.tsx`](../src/apps/student/components/MercadoPagoPixCheckout.tsx), Edge Functions de cartão/Pix/webhook | Alternável por ambiente; cartão e Pix com credenciais de teste. Pix aguarda confirmação assinada; split/OAuth e payout automático permanecem desabilitados (`TASK-080`). |
