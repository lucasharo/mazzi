...
| Pagamentos | Mercado Pago | `HOMOLOGAÇÃO/DEV` | [`src/apps/student/components/MercadoPagoCardCheckout.tsx`](../src/apps/student/components/MercadoPagoCardCheckout.tsx), [`src/apps/student/components/MercadoPagoPixCheckout.tsx`](../src/apps/student/components/MercadoPagoPixCheckout.tsx), Edge Functions de cartão/Pix/webhook | Alternável por ambiente; cartão e Pix com credenciais de teste. Cada troca de método cria uma tentativa própria e preserva a idempotência por chave; Pix aguarda confirmação assinada; split/OAuth e payout automático permanecem desabilitados (`TASK-080`). |
...
| Autoescola ↔ Instrutor | Convites, vínculo, compliance por escopo, elegibilidade e recontratação | `IMPLEMENTADO` | Migrations `20260821211805`, `20260821211815`, `20260821212128`, `20260821212131`, `20260821212134`, `20260821212313`, `20260821212317`, `20260821212518`, `20260821212857`, `20260821213335`, `20260821213422`, `20260821213516`; RPCs seguras e painel mínimo no MAZZI Pro | Backend LIVE aplicado; pagamentos DEV usam Mercado Pago de teste e o fake é somente local |
...
2. **Gateway de pagamento (`Product/Dev`):** fake permanece padrão e Mercado Pago está disponível para homologação de cartão em DEV. A próxima etapa é configurar credenciais de teste e concluir homologação antes de qualquer discussão de produção.
