-- MAZZI — Exibe repasses pendentes vencidos na previsão do PRO.
-- Um payout PENDING com scheduled_release_at no passado continua sendo devido
-- e não pode desaparecer do card "Próximos repasses".
...
BEGIN
  ...
  SELECT COALESCE(jsonb_agg(jsonb_build_object(
    ...
    'is_overdue', po.scheduled_release_at < NOW(),
  ...
  WHERE po.scheduled_release_at < NOW() + INTERVAL '7 days'
