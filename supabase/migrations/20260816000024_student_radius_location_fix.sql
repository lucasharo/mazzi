-- Providers use the generated PostGIS source-of-truth column for public
-- coordinates; the legacy location column may intentionally remain null.
create or replace function public.create_booking_hold_at_meeting_point(
  p_quote_id uuid, p_student_id uuid, p_idempotency_key varchar default null, p_meeting_point jsonb default null
