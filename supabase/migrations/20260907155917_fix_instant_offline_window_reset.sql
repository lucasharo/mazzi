-- Keep the canonical availability window consistent when the instructor logs out.
-- Going offline must clear both timestamps required by the check constraint.
